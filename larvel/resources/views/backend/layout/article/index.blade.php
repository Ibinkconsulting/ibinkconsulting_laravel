        ...
        <div class="card">
            <div class="card-header">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.article.create') }}" class="btn btn-primary" type="button">
    ...
    @push('script')
        ...
        <script>
            ...
            function deleteArticle(id) {
                let deleteUrl = '{{ route('admin.article.destroy', ':id') }}'.replace(':id', id);
                fetch(deleteUrl, {
                        method: 'DELETE',
                        headers: {
            ...
            function multi_delete() {
                ...
                if (ids.length == 0) {
                    ...
                    let url = "{{ route('admin.article.bulk-delete') }}";
