...
@section('title', 'Common Page - About Owner Section')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">About Owner Section</h4>

                        <form method="POST" action="{{ route('cms.common_page.about_owner_section.update') }}"
                            ...
                            <!-- Brand Icon -->
                            <div class="row mb-3">
                                <label for="icon" class="col-3 col-form-label"><i>Brand Icon</i></label>
                                <div class="col-9">
                                    <input type="file" name="icon" id="icon" class="dropify" accept="image/*"
                                        data-allowed-file-extensions="png jpg jpeg" data-max-file-size="5M"
                                        data-default-file="{{ isset($data->icon) ? asset($data->icon) : '' }}">
                                    @error('icon')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="file" name="logo" id="logo" class="dropify" accept="image/*"
                                        data-allowed-file-extensions="png jpg jpeg" data-max-file-size="5M"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="text" name="title" id="title" class="form-control"
                                        value="{{ old('title', $data?->title) }}" placeholder="Enter section title..."
                                        required>
                                    @error('title')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <!-- Sub Description -->
                            <div class="row mb-3">
                                <label for="sub_description" class="col-3 col-form-label"><i>Sub Description</i></label>
                                <div class="col-9">
                                    <textarea name="sub_description" id="sub_description"
                                        class="summernote form-control @error('sub_description') is-invalid @enderror">{!! old('sub_description', $data?->sub_description) !!}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="text" name="button_text" id="button_text" class="form-control"
                                        value="{{ old('button_text', $data?->button_text) }}" placeholder="e.g., Read More"
                                        required>
                                    @error('button_text')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="url" name="link_url" id="link_url" class="form-control" accept="url"
                                        value="{{ old('link_url', $data?->link_url) }}" placeholder="https://example.com">
                                    @error('link_url')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
