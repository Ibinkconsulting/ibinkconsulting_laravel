...
@section('title', 'Buy Page - Buying Property Section')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Buying Property Section Settings</h4>

                        <form method="POST" action="{{ route('cms.buy_page.buying_property_section.update') }}"
