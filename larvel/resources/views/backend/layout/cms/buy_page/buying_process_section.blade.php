...
@section('title', 'Buy Page - Buying Process Section')
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Buying Process Section Settings</h4>

                        <form method="POST" action="{{ route('cms.buy_page.buying_process_section.update') }}" class="form">
                            @csrf
                            @method('PATCH')
