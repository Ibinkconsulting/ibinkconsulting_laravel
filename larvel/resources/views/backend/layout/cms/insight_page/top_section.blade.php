...
@section('title', 'Insight Page - Top Section')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('cms.insight_page.top_section.update') }}"
                            ...
                            <div class="row mb-3">
                              ...
                              <!-- Sub Title -->
                            <div class="row mb-3">
                                <label for="sub_title" class="col-3 col-form-label"><i>Sub Title (Optional)</i></label>
                                <div class="col-9">
                                    <textarea 
                                        name="sub_title" 
                                        id="sub_title" 
                                        class="summernote form-control @error('sub_title') is-invalid @enderror"
                                        >{!! old('sub_title', $data?->sub_title) !!}</textarea>
                                    @error('sub_title') 
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a href="{{ route('cms.insight_page.top_section') }}"
