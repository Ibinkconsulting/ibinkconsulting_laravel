...
@section('title', 'Sell Page - Selling Property Section')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Selling Property Section Settings</h4>

                        <form method="POST" action="{{ route('cms.sell_page.selling_property_section.update') }}"
