...
@section('title', 'Common Page - About Pertnership Section')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">About Pernership Section</h4>

                        <form method="POST" action="{{ route('cms.common_page.about_pertnership_section.update') }}"
