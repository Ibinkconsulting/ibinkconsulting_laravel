...
@section('title', 'About Page - End File Section')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">End File Section</h4>

                        <form method="POST" action="{{ route('cms.about_page.end_file_section.update') }}"
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a href="{{ route('cms.about_page.end_file_section') }}"
