...
@section('title', 'Buy Page - Work With Us Section')
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Work With Us Section Settings</h4>

                        <form method="POST" action="{{ route('cms.buy_page.work_with_us_section.update') }}" class="form">
                            @csrf
                            @method('PATCH')
