                    ...
                    <div class="row">
                        <!-- <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="title" class="form-control"
                                    value="{{ $setting->title ?? '' }}" placeholder="System Title" name="title" />
                                @error('title')
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control dropify" type="file" name="white_logo"
                                    @isset($setting->white_logo)
                                                   data-default-file="{{ asset($setting->white_logo) }}"
                                    @endisset>
                                @error('white_logo')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="copyright" id="copyright"
                                    value="{{ $setting->copyright ?? '' }}" placeholder="Copyright Text">
                                @error('copyright')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="footer_text" class="form-control" id="footer_text" cols="30" rows="5">{{ $setting->footer_text ?? '' }}</textarea>
                                @error('footer_text')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <!-- <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea name="office_time" class="form-control" id="office_time" cols="30" rows="5">{{ $setting->office_time ?? '' }}</textarea>
                                @error('office_time')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <!-- <div class=" col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address" id="address"
                                    value="{{ $setting->address ?? '' }}" placeholder="Address Text">
                                @error('address')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
