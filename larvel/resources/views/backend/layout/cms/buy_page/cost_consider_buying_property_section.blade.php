...
@section('title', 'Buy Page - Cost Consider Buying Property')
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Cost Consider Buying Property Section</h4>

                        <form method="POST" action="{{ route('cms.buy_page.cost_consider_buying_property_section.update') }}" 
