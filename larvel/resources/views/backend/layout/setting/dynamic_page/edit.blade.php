...
<div class="app-content content ">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Dynamic Page Edit</h3>
            <div>
                <a href="{{ route('dynamicpages.index') }}" class="btn btn-primary" type="button">
                    <span>Dynamic Page List</span>
                </a>
            </div>
            ...
            <form action="{{ route('dynamicpages.update', $data->id) }}" method="POST" class="tm-form">
                ...
                <div class="form-field-wrapper">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="page_content" class="ck-editor form-control @error('page_content') is-invalid @enderror" id="page_content">{{ old('page_content') ?? $data->page_content ?? '' }}</textarea>
                        @error('page_content')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
