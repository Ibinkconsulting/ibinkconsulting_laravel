...
@section('title', 'About Page - Our Values Section')
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Our Values Section Settings</h4>

                        <form method="POST" action="{{ route('cms.about_page.our_values_section.update') }}" class="form">
                            @csrf
                            @method('PATCH')
