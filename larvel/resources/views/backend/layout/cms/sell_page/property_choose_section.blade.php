...
@section('title', 'Sell Page - Property Choose Section')
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Property Choose Section Settings</h4>

                        <form method="POST" action="{{ route('cms.sell_page.property_choose_section.update') }}" class="form">
                            @csrf
                            @method('PATCH')
                                    ...
                                    <div class="card mb-4 part-card border-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-9">
                                                    <textarea name="parts[{{ $index }}][description]"
