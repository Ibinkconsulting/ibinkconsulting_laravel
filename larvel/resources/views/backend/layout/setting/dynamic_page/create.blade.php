...
<div class="app-content content ">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Dynamic Page Create</h3>
            <div>
            ...
            <form class="form" method="POST" action="{{ route('dynamicpages.store') }}">
                ...
                <div class="form-field-wrapper">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="page_content" class="ck-editor form-control @error('page_content') is-invalid @enderror"    id="page_content">{{ old('page_content') }}</textarea>
                        @error('page_content')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
