...
@section('content')
    <div class="app-content content ">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form" method="POST" action="{{ route('admin.article.store') }}"
                    ...
                    <!-- title -->
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="title" class="form-control"
                                    value="{{ old('title') }}" placeholder="Article Title" name="title" />
                                @error('title')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea id="description" class="form-control summernote" placeholder="Article Description"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="file" id="image" class="dropify"
                                    value="{{ old('image') }}" placeholder="Article Image" name="image" />
                                @error('image')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="year" class="form-control"
                                    value="{{ old('year') }}" placeholder="Article Year" name="year" />
                                @error('year')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" id="order" class="form-control"
                                    value="{{ old('order') }}" placeholder="Article Order" name="order" />
                                @error('order')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
